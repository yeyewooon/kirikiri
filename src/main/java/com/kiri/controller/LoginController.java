...
public class LoginController {
	...
	public String general(String user_email, String user_pw, String loginType) throws Exception { // 일반로그인 feat.조용진
		//String Encryption_pw = ecp.getSHA512(user_pw); //살리기
		...
		if(type == null) { //미가입
			...
			//MemberDTO dto = service.login(user_email, Encryption_pw); //이게 맞음
			MemberDTO dto = service.login(user_email, user_pw); //지우기
