...
public class Group_CalendarDTO {
	...
	public Group_CalendarDTO(int seq_group_cal, int seq_group, String user_email, String title, String start,
	...
	public String toString() {
		return "Group_CalendarDTO [seq_group_cal=" + seq_group_cal + ", seq_group=" + seq_group + ", user_email="
				+ user_email + ", title=" + title + ", start=" + start + ", gcal_name=" + gcal_name + ", gcal_content="
