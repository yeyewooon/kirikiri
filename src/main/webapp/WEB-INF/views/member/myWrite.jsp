    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
                                ...
                                <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                                    <ul class="navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <c:if test="${not empty loginSession && loginSession.user_email eq 'admin'}">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="/admin/toAdmin">관리자페이지 이동</a>
                                            </li>
                                            <li class="nav-item"><a class="nav-link" href="/login/toLogout">로그아웃</a>
                                            </li>
                                        </c:if>
                                ...
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-auto">
                                        <ul class="navbar-nav mb-2 mb-lg-0 me-2">
                                            <c:if test="${empty loginSession}">
                                                <li class="nav-item"><a class="nav-link" href="/login/toLogin">로그인</a>
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="/signup/toSignupAgree">회원가입</a></li>
                                            </c:if>
                                        ...
                                        <c:if test="${not empty loginSession && loginSession.user_email eq 'admin'}">
                                            <div class="dropdown text-end">
                                                <a href="/"
                                                    ...
                                                    <img src="/resources/images/profile.jpg" alt="mdo" width="32"
                                                ...
                                                <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                                                    ...
                                                    <li><a class="dropdown-item" href="/admin/toAdmin">관리자 페이지이동</a>
                                                    </li>
            ...
            <div class="row m-0 topHeader">
            	<div class="row profileTitle mb-5 text-center justify-content-center">
					<h1>내가 쓴 글</h1>
					<div class="line"></div>
				</div>
	            ...
	            <form id="searchForm">
	                <div class="row mb-2">
	                    <div class="col-12" style="display:flex; justify-content:end;">
	                        ...
	                        <select class="form-select title me-2" aria-label="Default select example" name="boardNameCategory"
	                            style="width: 100px;">
	                            <option value="normal">일반</option>
	                            <option value="meeting">모임</option>
	                        </select>
	                        <select class="form-select me-2" aria-label="Default select example" name="category" id="category"
	                            style="width: 100px;">
	                            <option value="board_all">전체</option>
	                            <option value="board_title">제목</option>
	                            <option value="board_content">내용</option>
	                        </select>
	                        <input type="text" name="keyword" class="form-control keyword me-2" placeholder="검색"
	                            style="width: 250px;">
	                    ...
	                    <tbody>
	                        <c:forEach items="${list}" var="selectBoardList">
	                            <tr>
	                                ...
	                                <td><a href="/board/toDetailView?seq_board=${selectBoardList.seq_board}"
	                                        style="text-decoration:none; color:black;">${selectBoardList.board_content}</a>
	                                </td>
