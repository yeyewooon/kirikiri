	...
	<div class="container">
			...
			<div class="col p-0">
								...
								<div class="col-md-4 d-flex justify-content-center p-4">
									<div class="card" data-aos="flip-up" data-aos-duration="1000">
										<c:choose>
											...
											<c:otherwise>
												<img src="/resources/images/메인사진2(배경).png"
													id="profile_image" class="card-img-top">
											</c:otherwise>
										</c:choose>
										<span class="d-none seq_group">${dto.seq_group}</span>
										<div class="card-body">
											<div
												class="card-text-category d-flex justify-content-center align-items-center"
												style="color: #fff;">${dto.group_category}</div>
				...
				<div class="col-md-12" style="width: 100%">
					<div class="d-flex justify-content-center align-items-center more">
						<span>더보기</span><span class="ms-2"><i
		...
		<div class="row contentBest d-none">
			<div class="col p-0">
				...
				<div class="col-12" style="width: 100%">
					<div class="d-flex justify-content-center align-items-center more">
						<span style="font-color: grey;">더보기</span><span class="ms-2"><i
